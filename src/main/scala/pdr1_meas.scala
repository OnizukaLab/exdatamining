  ...
  def read_meas(sc: SparkContext) = {
    sc.textFile("hdfs://user/matsumoto/sample_pdr1_wide.photoz_demp").
      map { lines =>
        ...
        val merge_footprInt_i2 = elms(22)
        val merge_footprInt_i = elms(23)
        val merge_footprInt_r = elms(24)
        val merge_footprInt_z = elms(25)
        val merge_footprInt_y = elms(26)
        val merge_footprInt_g = elms(27)
        val merge_footprInt_n921 = elms(28)
        val merge_footprInt_n816 = elms(29)
        val merge_footprInt_n1010 = elms(30)
        val merge_footprInt_n387 = elms(31)
        val merge_footprInt_n515 = elms(32)
        val merge_footprInt_sky = elms(33)
        val merge_peak_i2 = elms(34)
        val merge_peak_i = elms(35)
        val merge_peak_r = elms(36)
        val merge_peak_z = elms(37)
        val merge_peak_y = elms(38)
        val merge_peak_g = elms(39)
        val merge_peak_n921 = elms(40)
        val merge_peak_n816 = elms(41)
        val merge_peak_n1010 = elms(42)
        val merge_peak_n387 = elms(43)
        val merge_peak_n515 = elms(44)
        val merge_peak_sky = elms(45)
        ...
        val gflux_psf_flags = elms(62)
        val gflux_psf_flags_apcorr = elms(63)
        ...
        val gflux_kron_flags = elms(73)
        val gflux_kron_flags_edge = elms(74)
        val gflux_kron_flags_radius = elms(75)
        val gflux_kron_flags_smallradius = elms(76)
        val gflux_kron_flags_usedminimumradius = elms(77)
        val gflux_kron_flags_usedpsfradius = elms(78)
        val gflux_kron_flags_badshape = elms(79)
        val gflux_kron_flags_apcorr = elms(80)
        ...
        val gflux_gaussian_flags = elms(87)
        val gflux_gaussian_flags_apcorr = elms(88)
        ...
        val gcmodel_initial_flux_flags = elms(165)
        val gcmodel_initial_flags_trsmall = elms(166)
        val gcmodel_initial_flags_maxiter = elms(167)
        val gcmodel_initial_flags_numericerror = elms(168)
        val gcmodel_exp_flux_flags = elms(169)
        val gcmodel_exp_flags_trsmall = elms(170)
        val gcmodel_exp_flags_maxiter = elms(171)
        val gcmodel_exp_flags_numericerror = elms(172)
        val gcmodel_dev_flux_flags = elms(173)
        val gcmodel_dev_flags_trsmall = elms(174)
        val gcmodel_dev_flags_maxiter = elms(175)
        val gcmodel_dev_flags_numericerror = elms(176)
        val gcmodel_flux_flags = elms(177)
        val gcmodel_flags_region_maxarea = elms(178)
        val gcmodel_flags_region_maxbadpixelfraction = elms(179)
        val gcmodel_flags_region_usedfootprIntarea = elms(180)
        val gcmodel_flags_region_usedpsfarea = elms(181)
        val gcmodel_flags_region_usedinitialellipsemin = elms(182)
        val gcmodel_flags_region_usedinitialellipsemax = elms(183)
        val gcmodel_flags_noshape = elms(184)
        val gcmodel_flags_smallshape = elms(185)
        val gcmodel_flags_nopsf = elms(186)
        val gcmodel_flags_nowcs = elms(187)
        val gcmodel_flags_nocalib = elms(188)
        val gcmodel_flags_badcentroid = elms(189)
        val gcmodel_dev_flux_flags_apcorr = elms(190)
        val gcmodel_exp_flux_flags_apcorr = elms(191)
        val gcmodel_flux_flags_apcorr = elms(192)
        ...
        val gdeblend_deblended_as_psf = elms(220)
        val gdeblend_too_many_peaks = elms(221)
        val gdeblend_parent_too_big = elms(222)
        val gdeblend_masked = elms(223)
        val gdeblend_skipped = elms(224)
        val gdeblend_ramped_template = elms(225)
        val gdeblend_patched_template = elms(226)
        val gdeblend_has_stray_flux = elms(227)
        val gblendedness_flags = elms(228)
        val gblendedness_flags_nocentroid = elms(229)
        val gblendedness_flags_noshape = elms(230)
        val gcountinputs = elms(231).toInt
        val gclassification_extendedness = elms(232).toFloat
        val gflags_negative = elms(233)
        val gflags_badcentroid = elms(234)
        val gflags_pixel_edge = elms(235)
        val gflags_pixel_Interpolated_any = elms(236)
        val gflags_pixel_Interpolated_center = elms(237)
        val gflags_pixel_saturated_any = elms(238)
        val gflags_pixel_saturated_center = elms(239)
        val gflags_pixel_cr_any = elms(240)
        val gflags_pixel_cr_center = elms(241)
        val gflags_pixel_bad = elms(242)
        val gflags_pixel_suspect_any = elms(243)
        val gflags_pixel_suspect_center = elms(244)
        val gflags_pixel_offimage = elms(245)
        val gflags_pixel_bright_object_center = elms(246)
        val gflags_pixel_clipped_any = elms(247)
        val gflags_pixel_bright_object_any = elms(248)
        val gdetect_is_patch_inner = elms(249)
        val gdetect_is_tract_inner = elms(250)
        val gdetect_is_primary = elms(251)
        val gcalib_psf_candidate = elms(252)
        val gcalib_psf_used = elms(253)
        ...
        val rflux_naive_flags = elms(258)
        ...
        val rflux_psf_flags = elms(270)
        val rflux_psf_flags_apcorr = elms(271)
        ...
        val rflux_kron_flags = elms(281)
        val rflux_kron_flags_edge = elms(282)
        val rflux_kron_flags_radius = elms(283)
        val rflux_kron_flags_smallradius = elms(284)
        val rflux_kron_flags_usedminimumradius = elms(285)
        val rflux_kron_flags_usedpsfradius = elms(286)
        val rflux_kron_flags_badshape = elms(287)
        val rflux_kron_flags_apcorr = elms(288)
        ...
        val rflux_gaussian_flags = elms(295)
        val rflux_gaussian_flags_apcorr = elms(296)
        ...
        val rcmodel_initial_flux_flags = elms(373)
        val rcmodel_initial_flags_trsmall = elms(374)
        val rcmodel_initial_flags_maxiter = elms(375)
        val rcmodel_initial_flags_numericerror = elms(376)
        val rcmodel_exp_flux_flags = elms(377)
        val rcmodel_exp_flags_trsmall = elms(378)
        val rcmodel_exp_flags_maxiter = elms(379)
        val rcmodel_exp_flags_numericerror = elms(380)
        val rcmodel_dev_flux_flags = elms(381)
        val rcmodel_dev_flags_trsmall = elms(382)
        val rcmodel_dev_flags_maxiter = elms(383)
        val rcmodel_dev_flags_numericerror = elms(384)
        val rcmodel_flux_flags = elms(385)
        val rcmodel_flags_region_maxarea = elms(386)
        val rcmodel_flags_region_maxbadpixelfraction = elms(387)
        val rcmodel_flags_region_usedfootprIntarea = elms(388)
        val rcmodel_flags_region_usedpsfarea = elms(389)
        val rcmodel_flags_region_usedinitialellipsemin = elms(390)
        val rcmodel_flags_region_usedinitialellipsemax = elms(391)
        val rcmodel_flags_noshape = elms(392)
        val rcmodel_flags_smallshape = elms(393)
        val rcmodel_flags_nopsf = elms(394)
        val rcmodel_flags_nowcs = elms(395)
        val rcmodel_flags_nocalib = elms(396)
        val rcmodel_flags_badcentroid = elms(397)
        val rcmodel_dev_flux_flags_apcorr = elms(398)
        val rcmodel_exp_flux_flags_apcorr = elms(399)
        val rcmodel_flux_flags_apcorr = elms(400)
        ...
        val rdeblend_deblended_as_psf = elms(428)
        val rdeblend_too_many_peaks = elms(429)
        val rdeblend_parent_too_big = elms(430)
        val rdeblend_masked = elms(431)
        val rdeblend_skipped = elms(432)
        val rdeblend_ramped_template = elms(433)
        val rdeblend_patched_template = elms(434)
        val rdeblend_has_stray_flux = elms(435)
        val rblendedness_flags = elms(436)
        val rblendedness_flags_nocentroid = elms(437)
        val rblendedness_flags_noshape = elms(438)
        val rcountinputs = elms(439).toInt
        val rclassification_extendedness = elms(440).toFloat
        val rflags_negative = elms(441)
        val rflags_badcentroid = elms(442)
        val rflags_pixel_edge = elms(443)
        val rflags_pixel_Interpolated_any = elms(444)
        val rflags_pixel_Interpolated_center = elms(445)
        val rflags_pixel_saturated_any = elms(446)
        val rflags_pixel_saturated_center = elms(447)
        val rflags_pixel_cr_any = elms(448)
        val rflags_pixel_cr_center = elms(449)
        val rflags_pixel_bad = elms(450)
        val rflags_pixel_suspect_any = elms(451)
        val rflags_pixel_suspect_center = elms(452)
        val rflags_pixel_offimage = elms(453)
        val rflags_pixel_bright_object_center = elms(454)
        val rflags_pixel_clipped_any = elms(455)
        val rflags_pixel_bright_object_any = elms(456)
        val rdetect_is_patch_inner = elms(457)
        val rdetect_is_tract_inner = elms(458)
        val rdetect_is_primary = elms(459)
        val rcalib_psf_candidate = elms(460)
        val rcalib_psf_used = elms(461)
        ...
        val iflux_naive_flags = elms(466)
        ...
        val iflux_psf_flags = elms(478)
        val iflux_psf_flags_apcorr = elms(479)
        ...
        val iflux_kron_flags = elms(489)
        val iflux_kron_flags_edge = elms(490)
        val iflux_kron_flags_radius = elms(491)
        val iflux_kron_flags_smallradius = elms(492)
        val iflux_kron_flags_usedminimumradius = elms(493)
        val iflux_kron_flags_usedpsfradius = elms(494)
        val iflux_kron_flags_badshape = elms(495)
        val iflux_kron_flags_apcorr = elms(496)
        ...
        val iflux_gaussian_flags = elms(503)
        val iflux_gaussian_flags_apcorr = elms(504)
        ...
        val icmodel_initial_flux_flags = elms(581)
        val icmodel_initial_flags_trsmall = elms(582)
        val icmodel_initial_flags_maxiter = elms(583)
        val icmodel_initial_flags_numericerror = elms(584)
        val icmodel_exp_flux_flags = elms(585)
        val icmodel_exp_flags_trsmall = elms(586)
        val icmodel_exp_flags_maxiter = elms(587)
        val icmodel_exp_flags_numericerror = elms(588)
        val icmodel_dev_flux_flags = elms(589)
        val icmodel_dev_flags_trsmall = elms(590)
        val icmodel_dev_flags_maxiter = elms(591)
        val icmodel_dev_flags_numericerror = elms(592)
        val icmodel_flux_flags = elms(593)
        val icmodel_flags_region_maxarea = elms(594)
        val icmodel_flags_region_maxbadpixelfraction = elms(595)
        val icmodel_flags_region_usedfootprIntarea = elms(596)
        val icmodel_flags_region_usedpsfarea = elms(597)
        val icmodel_flags_region_usedinitialellipsemin = elms(598)
        val icmodel_flags_region_usedinitialellipsemax = elms(599)
        val icmodel_flags_noshape = elms(600)
        val icmodel_flags_smallshape = elms(601)
        val icmodel_flags_nopsf = elms(602)
        val icmodel_flags_nowcs = elms(603)
        val icmodel_flags_nocalib = elms(604)
        val icmodel_flags_badcentroid = elms(605)
        val icmodel_dev_flux_flags_apcorr = elms(606)
        val icmodel_exp_flux_flags_apcorr = elms(607)
        val icmodel_flux_flags_apcorr = elms(608)
        ...
        val ideblend_deblended_as_psf = elms(636)
        val ideblend_too_many_peaks = elms(637)
        val ideblend_parent_too_big = elms(638)
        val ideblend_masked = elms(639)
        val ideblend_skipped = elms(640)
        val ideblend_ramped_template = elms(641)
        val ideblend_patched_template = elms(642)
        val ideblend_has_stray_flux = elms(643)
        val iblendedness_flags = elms(644)
        val iblendedness_flags_nocentroid = elms(645)
        val iblendedness_flags_noshape = elms(646)
        val icountinputs = elms(647).toInt
        val iclassification_extendedness = elms(648).toFloat
        val iflags_negative = elms(649)
        val iflags_badcentroid = elms(650)
        val iflags_pixel_edge = elms(651)
        val iflags_pixel_Interpolated_any = elms(652)
        val iflags_pixel_Interpolated_center = elms(653)
        val iflags_pixel_saturated_any = elms(654)
        val iflags_pixel_saturated_center = elms(655)
        val iflags_pixel_cr_any = elms(656)
        val iflags_pixel_cr_center = elms(657)
        val iflags_pixel_bad = elms(658)
        val iflags_pixel_suspect_any = elms(659)
        val iflags_pixel_suspect_center = elms(660)
        val iflags_pixel_offimage = elms(661)
        val iflags_pixel_bright_object_center = elms(662)
        val iflags_pixel_clipped_any = elms(663)
        val iflags_pixel_bright_object_any = elms(664)
        val idetect_is_patch_inner = elms(665)
        val idetect_is_tract_inner = elms(666)
        val idetect_is_primary = elms(667)
        val icalib_psf_candidate = elms(668)
        val icalib_psf_used = elms(669)
        ...
        val zflux_naive_flags = elms(674)
        ...
        val zflux_psf_flags = elms(686)
        val zflux_psf_flags_apcorr = elms(687)
        ...
        val zflux_kron_flags = elms(697)
        val zflux_kron_flags_edge = elms(698)
        val zflux_kron_flags_radius = elms(699)
        val zflux_kron_flags_smallradius = elms(700)
        val zflux_kron_flags_usedminimumradius = elms(701)
        val zflux_kron_flags_usedpsfradius = elms(702)
        val zflux_kron_flags_badshape = elms(703)
        val zflux_kron_flags_apcorr = elms(704)
        ...
        val zflux_gaussian_flags = elms(711)
        val zflux_gaussian_flags_apcorr = elms(712)
        ...
        val zcmodel_initial_flux_flags = elms(789)
        val zcmodel_initial_flags_trsmall = elms(790)
        val zcmodel_initial_flags_maxiter = elms(791)
        val zcmodel_initial_flags_numericerror = elms(792)
        val zcmodel_exp_flux_flags = elms(793)
        val zcmodel_exp_flags_trsmall = elms(794)
        val zcmodel_exp_flags_maxiter = elms(795)
        val zcmodel_exp_flags_numericerror = elms(796)
        val zcmodel_dev_flux_flags = elms(797)
        val zcmodel_dev_flags_trsmall = elms(798)
        val zcmodel_dev_flags_maxiter = elms(799)
        val zcmodel_dev_flags_numericerror = elms(800)
        val zcmodel_flux_flags = elms(801)
        val zcmodel_flags_region_maxarea = elms(802)
        val zcmodel_flags_region_maxbadpixelfraction = elms(803)
        val zcmodel_flags_region_usedfootprIntarea = elms(804)
        val zcmodel_flags_region_usedpsfarea = elms(805)
        val zcmodel_flags_region_usedinitialellipsemin = elms(806)
        val zcmodel_flags_region_usedinitialellipsemax = elms(807)
        val zcmodel_flags_noshape = elms(808)
        val zcmodel_flags_smallshape = elms(809)
        val zcmodel_flags_nopsf = elms(810)
        val zcmodel_flags_nowcs = elms(811)
        val zcmodel_flags_nocalib = elms(812)
        val zcmodel_flags_badcentroid = elms(813)
        val zcmodel_dev_flux_flags_apcorr = elms(814)
        val zcmodel_exp_flux_flags_apcorr = elms(815)
        val zcmodel_flux_flags_apcorr = elms(816)
        ...
        val zdeblend_deblended_as_psf = elms(844)
        val zdeblend_too_many_peaks = elms(845)
        val zdeblend_parent_too_big = elms(846)
        val zdeblend_masked = elms(847)
        val zdeblend_skipped = elms(848)
        val zdeblend_ramped_template = elms(849)
        val zdeblend_patched_template = elms(850)
        val zdeblend_has_stray_flux = elms(851)
        val zblendedness_flags = elms(852)
        val zblendedness_flags_nocentroid = elms(853)
        val zblendedness_flags_noshape = elms(854)
        val zcountinputs = elms(855).toInt
        val zclassification_extendedness = elms(856).toFloat
        val zflags_negative = elms(857)
        val zflags_badcentroid = elms(858)
        val zflags_pixel_edge = elms(859)
        val zflags_pixel_Interpolated_any = elms(860)
        val zflags_pixel_Interpolated_center = elms(861)
        val zflags_pixel_saturated_any = elms(862)
        val zflags_pixel_saturated_center = elms(863)
        val zflags_pixel_cr_any = elms(864)
        val zflags_pixel_cr_center = elms(865)
        val zflags_pixel_bad = elms(866)
        val zflags_pixel_suspect_any = elms(867)
        val zflags_pixel_suspect_center = elms(868)
        val zflags_pixel_offimage = elms(869)
        val zflags_pixel_bright_object_center = elms(870)
        val zflags_pixel_clipped_any = elms(871)
        val zflags_pixel_bright_object_any = elms(872)
        val zdetect_is_patch_inner = elms(873)
        val zdetect_is_tract_inner = elms(874)
        val zdetect_is_primary = elms(875)
        val zcalib_psf_candidate = elms(876)
        val zcalib_psf_used = elms(877)
        ...
        val yflux_naive_flags = elms(882)
        ...
        val yflux_psf_flags = elms(894)
        val yflux_psf_flags_apcorr = elms(895)
        ...
        val yflux_kron_flags = elms(905)
        val yflux_kron_flags_edge = elms(906)
        val yflux_kron_flags_radius = elms(907)
        val yflux_kron_flags_smallradius = elms(908)
        val yflux_kron_flags_usedminimumradius = elms(909)
        val yflux_kron_flags_usedpsfradius = elms(910)
        val yflux_kron_flags_badshape = elms(911)
        val yflux_kron_flags_apcorr = elms(912)
        ...
        val yflux_gaussian_flags = elms(919)
        val yflux_gaussian_flags_apcorr = elms(920)
        ...
        val ycmodel_initial_flux_flags = elms(997)
        val ycmodel_initial_flags_trsmall = elms(998)
        val ycmodel_initial_flags_maxiter = elms(999)
        val ycmodel_initial_flags_numericerror = elms(1000)
        val ycmodel_exp_flux_flags = elms(1001)
        val ycmodel_exp_flags_trsmall = elms(1002)
        val ycmodel_exp_flags_maxiter = elms(1003)
        val ycmodel_exp_flags_numericerror = elms(1004)
        val ycmodel_dev_flux_flags = elms(1005)
        val ycmodel_dev_flags_trsmall = elms(1006)
        val ycmodel_dev_flags_maxiter = elms(1007)
        val ycmodel_dev_flags_numericerror = elms(1008)
        val ycmodel_flux_flags = elms(1009)
        val ycmodel_flags_region_maxarea = elms(1010)
        val ycmodel_flags_region_maxbadpixelfraction = elms(1011)
        val ycmodel_flags_region_usedfootprIntarea = elms(1012)
        val ycmodel_flags_region_usedpsfarea = elms(1013)
        val ycmodel_flags_region_usedinitialellipsemin = elms(1014)
        val ycmodel_flags_region_usedinitialellipsemax = elms(1015)
        val ycmodel_flags_noshape = elms(1016)
        val ycmodel_flags_smallshape = elms(1017)
        val ycmodel_flags_nopsf = elms(1018)
        val ycmodel_flags_nowcs = elms(1019)
        val ycmodel_flags_nocalib = elms(1020)
        val ycmodel_flags_badcentroid = elms(1021)
        val ycmodel_dev_flux_flags_apcorr = elms(1022)
        val ycmodel_exp_flux_flags_apcorr = elms(1023)
        val ycmodel_flux_flags_apcorr = elms(1024)
        ...
        val ydeblend_deblended_as_psf = elms(1052)
        val ydeblend_too_many_peaks = elms(1053)
        val ydeblend_parent_too_big = elms(1054)
        val ydeblend_masked = elms(1055)
        val ydeblend_skipped = elms(1056)
        val ydeblend_ramped_template = elms(1057)
        val ydeblend_patched_template = elms(1058)
        val ydeblend_has_stray_flux = elms(1059)
        val yblendedness_flags = elms(1060)
        val yblendedness_flags_nocentroid = elms(1061)
        val yblendedness_flags_noshape = elms(1062)
        val ycountinputs = elms(1063).toInt
        val yclassification_extendedness = elms(1064).toFloat
        val yflags_negative = elms(1065)
        val yflags_badcentroid = elms(1066)
        val yflags_pixel_edge = elms(1067)
        val yflags_pixel_Interpolated_any = elms(1068)
        val yflags_pixel_Interpolated_center = elms(1069)
        val yflags_pixel_saturated_any = elms(1070)
        val yflags_pixel_saturated_center = elms(1071)
        val yflags_pixel_cr_any = elms(1072)
        val yflags_pixel_cr_center = elms(1073)
        val yflags_pixel_bad = elms(1074)
        val yflags_pixel_suspect_any = elms(1075)
        val yflags_pixel_suspect_center = elms(1076)
        val yflags_pixel_offimage = elms(1077)
        val yflags_pixel_bright_object_center = elms(1078)
        val yflags_pixel_clipped_any = elms(1079)
        val yflags_pixel_bright_object_any = elms(1080)
        val ydetect_is_patch_inner = elms(1081)
        val ydetect_is_tract_inner = elms(1082)
        val ydetect_is_primary = elms(1083)
        val ycalib_psf_candidate = elms(1084)
        val ycalib_psf_used = elms(1085)
        (
          object_id
